...
const AddQuestions = React.lazy(() => import('./components/Questions/AddQuestions'));
const AllQuestions = React.lazy(() => import('./components/Questions/AllQuestions'));
const EditQuestions = React.lazy(() => import('./components/Questions/EditQuestions'));
